...
public class FragmentPagePosition_son1 extends BaseFragment {
    ...
    //定义日期格式
    private SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yy年MM月dd日EEEE", Locale.CHINA);
    private DateFormat monthNameFormat = new SimpleDateFormat("MMMM yyyy",Locale.CHINA);
    private DateFormat monthWeekFormat = new SimpleDateFormat("M月d日EEEE",Locale.CHINA);
...
//                onekeyShare.disableSSOWhenAuthorize();
        ...
        tv_recorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageButton imageButtonLast = (ImageButton) contentView.findViewById(R.id.btn_last);
                ImageButton imageButtonNext = (ImageButton) contentView.findViewById(R.id.btn_next);

                final GregorianCalendar now = new GregorianCalendar(Locale.CHINA);
                tv_month.setText(monthNameFormat.format(now.getTime()));

                final ViewPager vp = (ViewPager) contentView.findViewById(R.id.vp_calendar);
                ...
                vp.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                    ...
                    public void onPageSelected(int position) {
                        ...
                        tv_month.setText(now.get(Calendar.YEAR) + "年" + (now.get(Calendar.MONTH) + 1) + "月");
                        now.add(Calendar.MONTH, -(position + 1 - month));
                    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        tv_date.setText(monthWeekFormat.format(new Date()));
